...
<?php
session_start();
if (!$_GET || !in_array($_GET['help'], array("help", "features", "change", "about", "contact"))) {
	$default = 'help';
} else if ($_GET) {
	$default = $_GET['help'];
}
...
<body class="help-bg">
	...
	<div class="container-fluid">
		<div id="top" class="help-banner">
			<h2 class="helpHeader centered"><img src="/resources/icons/lemon-icon.png" width="70" height="70" class="d-inline-block">ZEST SUPPORT</h2>
		</div>
			...
			<div class="col-md-10">
				<ul class="nav nav-tabs nav-pills with-arrow flex-sm-row">
					<li class="nav-item flex-sm-fill text-center helpTitle">
						<a class="nav-link<?php if ($default == "help") {
												echo " active";
											} ?>" data-toggle="pill" href="#help">Getting Started</a>
					</li>
					<li class="nav-item flex-sm-fill text-center helpTitle">
						<a class="nav-link<?php if ($default == "features") {
												echo " active";
											} ?>" data-toggle="pill" href="#features">Features</a>
					</li>
					<li class="nav-item flex-sm-fill text-center helpTitle">
						<a class="nav-link<?php if ($default == "change") {
												echo " active";
											} ?>" data-toggle="pill" href="#change">Change your Password?</a>
					</li>
					<li class="nav-item flex-sm-fill text-center helpTitle">
						<a class="nav-link<?php if ($default == "about") {
												echo " active";
											} ?>" data-toggle="pill" href="#about">About Us</a>
					</li>
					<li class="nav-item flex-sm-fill text-center helpTitle">
						<a class="nav-link<?php if ($default == "contact") {
												echo " active";
											} ?>" data-toggle="pill" href="#contact">Contact Us</a>
					</li>
				</ul>
				<br>
				<div class="tab-content">
					<div id="help" class="tab-pane container<?php if ($default == "help") {
																echo " active";
															} else {
																echo " fade";
															} ?>">
						<div class="row  bg-white rounded shadow">
							...
							<div class="col-7">
								...
								<div class=" text-center text-break text-dark">
									...
									<br>...<br>
									<a class="helpLink" href="help.php?help=about"><button class="btn btn-warning">
						...
						<div class="row bg-white rounded shadow">
							...
							<div class="col-10">
								...
								<div class="text-break text-center">
									...
									<br><br>
									<a class="helpLink" href="index.php"><button class="btn btn-warning">
											<div class="font-weight-bold">Try Now </div>
										</button></a>
								</div>
								<br>
						...
						<div class="row">
							...
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-register.jpg">
									<div class="card-body">
							...
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-login.jpg">
									<div class="card-body">
						...
						<div class="row">
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-home.png">
									<div class="card-body">
							...
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-profile.png">
									<div class="card-body">
						...
						<div class="row">
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-avatars.jpg">
									<div class="card-body">
							...
							<div class="col-6 d-flex align-items-stretch">
								<div class="card">
									<img class="card-img-top" src="/resources/help/help-banner.jpg">
									<div class="card-body">
					...
					<div id="features" class="tab-pane container helpContent rounded px-4 py-5<?php if ($default == "features") {
																									echo " active";
																								} else {
																									echo " fade";
																								} ?>">
						...
						<div class="row">
							<div class="col-12 d-flex align-items-stretch">
								<div class="card rounded-all-1rem">
									...
									<img class="card-img-top" src="/resources/help/help-subjects.png">
									<div class="card-body">
										<div class="card-text text-justify">
						...
						<div class="row">
							<div class="col-12 d-flex align-items-stretch">
								<div class="card rounded-all-1rem">
									...
									<img class="card-img-top" src="/resources/help/help-tasks.png">
									<div class="card-body">
										<div class="card-text text-justify">
						...
						<div class="row">
							<div class="col-12 d-flex align-items-stretch">
								<div class="card rounded-all-1rem">
									...
									<img class="card-img-top" src="/resources/help/help-notes.png">
									<div class="card-body">
										<div class="card-text text-justify">
											In this section, you can be able to add, edit or delete notes. <br><br>
											<h4>Add Note</h4>
											<ol>
					...
					<div id="change" class="tab-pane container helpContent rounded px-4 py-5<?php if ($default == "change") {
																								echo " active";
																							} else {
																								echo " fade";
																							} ?>">
					...
					<div id="about" class="tab-pane container helpContent rounded px-4 py-5<?php if ($default == "about") {
																								echo " active";
																							} else {
																								echo " fade";
																							} ?>">
						...
						<div class="row rounded shadow bg-white">
							...
							<div class="col-10">
								...
								<div class="row">
									...
									<div class="col-8">
										<div class="helpText text-center">
											<b>ZEST</b> is an application designed to help you in your work, school, or office with absolute productivity. Created by 11 aspiring software developers from the University of the Philippines Visayas.
											<br><br>
											Zest will be there for you whenever you need to take note of your journey and be creative at the same time. Zest will remind you of your upcoming tasks and will absolutely be your friend in the process as well.
											<br><br>
								...
								<div class="helpText text-center">
									<a class="helpLink" href="help.php?help=help">Overview</a> |
									<a class="helpLink" href="help.php?help=features">Features</a> |
									<a class="helpLink" href="help.php?help=change">Change Password</a> |
									<a class="helpLink" href="help.php?help=contact">Contact us</a>
									<br><br>
								</div>
					...
					<div id="contact" class="tab-pane container helpContent rounded px-4 py-5<?php if ($default == "contact") {
																									echo " active";
																								} else {
																									echo " fade";
																								} ?>">
						<div class="row rounded shadow bg-white">
							<div class="col-12">
								...
								<div class="helpText text-center">
									...
									<a class="helpLink" href="help.php?help=features">Features</a> |
									<a class="helpLink" href="help.php?help=change">Change Password</a> |
									<a class="helpLink" href="help.php?help=about">About us</a>
									<br><br>
								</div>
							</div>
						</div>
