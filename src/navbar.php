 ...
 <div id="mySidebar" class="sidebar" onmouseover="toggleSidebar()" onmouseout="toggleSidebar()">
     ...
     <a class="navbar-brand" href="index.php">
         ...
         </svg><span class="icon-text"> Home</span></a>
     <hr>
     <a href="subjects.php">
         ...
         </svg><span class="icon-text"> Subject</span></a>
     <a href="tasks.php">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="bi bi-ui-checks nav-icon">
         ...
         </svg><span class="icon-text"> Task</span></a>
     <a href="notes.php">
         <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="bi bi-journal-text nav-icon">
             <path d="M3 0h10a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2v-1h1v1a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H3a1 1 0 0 0-1 1v1H1V2a2 2 0 0 1 2-2z" />
             <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1H1z" />
             <path fill-rule="evenodd" d="M5 10.5a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z" />
         </svg><span class="icon-text"> Notebook</span></a>
     <br>
     <br>
     <br>
     ...
     <span class="actions">
         <?php
            ...
            <img class='nav-icon' src='/cmsc128/resources/avatars/" . $user_Avatar . ".jpg'>
        ...
        </svg><span class='icon-text'> Login</span></a>
            </a>";
            }
            ?>
     </span>
     <!-- Help and Support Page - Please Change Icon and Position. Thanks! -->
     <a href="help.php?help=need">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" class="bi bi-circle-square nav-icon">
             <path d="M0 6a6 6 0 1 1 12 0A6 6 0 0 1 0 6z" />
             <path d="M12.93 5h1.57a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5v-1.57a6.953 6.953 0 0 1-1-.22v1.79A1.5 1.5 0 0 0 5.5 16h9a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 4h-1.79c.097.324.17.658.22 1z" />
         </svg><span class="icon-text"> Help</span>
     </a>
 </div>
 <div>
     <br><br>
