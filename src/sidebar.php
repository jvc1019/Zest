...
<div id="sidebar" class="sidebar">
    <div>
        <a href="index.php">
            <img class="nav-icon rounded" style="filter: invert(100%)" src="../resources/icons/zest.png">
        ...
        <a href="subjects.php">
            ...
            <span class="icon-text"> Subject</span>
        </a>
        <a href="tasks.php">
            ...
            <span class="icon-text"> Task</span>
        </a>
        <a href="notes.php">
        ...
        <br>
        <br>
        <a href="help.php?help=help" target="_blank">
	    	<svg viewBox="0 0 16 16" class="bi bi-question-square-fill nav-icon" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="actions">
        ...
        <?php } else { ?>
            <a href='login.php'>
                ...
                </svg><span class='icon-text'> Login</span>
            </a>
