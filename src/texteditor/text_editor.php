...
<div class="form-group">
    <div contenteditable="true" class="form-control border-primary border-top-0 border-left-0 border-right-0 rounded-0 d-inline-block editor_textarea" data-placeholder="Placeholder text here"><?php if (!empty($row["note_Content"])) {
