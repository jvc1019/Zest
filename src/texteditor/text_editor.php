...
<div class="form-group editor">
    ...
    <div contenteditable="true" class="form-control overflow-auto border-primary border-top-0 border-left-0 border-right-0 rounded-0 d-inline-block editor_textarea" data-placeholder="Click here to add something..." align="left"><?php if (!empty($row["note_Content"])) {
