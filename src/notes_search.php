                    ...
                    <div class="modal fade" id="editNote<?php echo $row['note_ID']; ?>" tabindex="-1" role="dialog" aria-labelledby="Task Details" aria-hidden="true">	<div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="POST" id="editForm" action="notes_edit.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row mx-5 px-4 justify-content-center">
                                            <div class="form-row">
                                                <div class="col">
                                                    <input class="mr-2 form-control text-truncate border-primary border-top-0 border-left-0 border-right-0 rounded-0" type="text" id="note_Title" value="<?php echo $row['note_Title'] ?>">
                                                </div>
                                                <div class="col">
                                                    <input class="ml-0 form-control text-truncate border-primary border-top-0 border-left-0 border-right-0 rounded-0" type=" text" onkeyup="nospaces(this)" id="note_Tags" value="<?php echo $row['note_Tags'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <!-- content form -->
                                        <br>
                                        <div class="row justify-content-center my-1" id="note_Content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="submitNote" class="btn btn-sm text-primary search">
                                        <!-- check/floppy icon -->
